...
const SYMBOLS: readonly SymbolDef[] = [
  { id: "zeus", weight: 5, pay: 2.4 },
  { id: "bolt", weight: 8, pay: 1.85 },
  { id: "crown", weight: 10, pay: 1.45 },
  { id: "chalice", weight: 12, pay: 1.15 },
  { id: "hammer", weight: 14, pay: 0.95 },
  { id: "orb", weight: 16, pay: 0.78 },
  { id: "coin", weight: 18, pay: 0.62 },
];
