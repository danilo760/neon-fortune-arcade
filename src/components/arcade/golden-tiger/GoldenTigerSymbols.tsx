...
export const GoldenTigerSymbol = memo(function GoldenTigerSymbol({ id, isWinning = false }: Props) {
  return (
    <div className={`gt-hw-symbol ${isWinning ? "is-winning" : ""}`} data-symbol={id} aria-label={id}>
      {id === "wild" && (
      ...
      {id === "lion" && (
        <svg viewBox="0 0 100 100" aria-hidden>
          ...
          <path d="M37 43q5-5 10 0M63 43q-5-5-10 0" stroke="#4c1c08" strokeWidth="3" strokeLinecap="round" fill="none" />
          <path d="m45 54 5 5 5-5M38 64q12 10 24 0" stroke="#4c1c08" strokeWidth="3" strokeLinecap="round" fill="none" />
      ...
      {id === "firecracker" && (
        <svg viewBox="0 0 100 100" aria-hidden>
          ...
          <g transform="rotate(-12 50 52)">
            <rect x="31" y="26" width="38" height="17" rx="5" fill="#cf1628" stroke="#ffd86a" strokeWidth="2" />
            <rect x="31" y="46" width="38" height="17" rx="5" fill="#b70d1d" stroke="#ffd86a" strokeWidth="2" />
            <rect x="31" y="66" width="38" height="17" rx="5" fill="#cf1628" stroke="#ffd86a" strokeWidth="2" />
            <path d="M38 34h24M38 54h24M38 74h24" stroke="#fff1a3" strokeWidth="2" />
          </g>
        </svg>
      )}
      ...
      {id === "jade" && (
        <svg viewBox="0 0 100 100" aria-hidden>
          <circle cx="50" cy="52" r="37" fill="#159f82" stroke="#b7ffe7" strokeWidth="3" />
          <circle cx="50" cy="52" r="16" fill="#071a17" stroke="#8df6d5" strokeWidth="3" />
          <path d="M50 15v-9M45 10h10M27 37q23-15 46 0M27 67q23 15 46 0" stroke="#6ae7c0" strokeWidth="2" fill="none" />
          <path d="M45 9q5-6 10 0" stroke="#e22d38" strokeWidth="3" fill="none" />
        </svg>
      )}

      {id === "lantern" && (
        <svg viewBox="0 0 100 100" aria-hidden>
          <path d="M39 14h22v8H39zM37 78h26v8H37z" fill="#dfa516" stroke="#fff0a6" strokeWidth="2" />
          <path d="M38 22q-20 27 0 56h24q20-29 0-56Z" fill="#ce2549" stroke="#ffb6c6" strokeWidth="2" />
          <path d="M50 22v56M42 23q-9 27 0 54M58 23q9 27 0 54" stroke="#ff91ad" strokeWidth="2" fill="none" />
          <path d="M44 86v9M50 86v11M56 86v9" stroke="#f04343" strokeWidth="2" />
        </svg>
      )}

      {id === "orange" && (
        <svg viewBox="0 0 100 100" aria-hidden>
          <path d="M50 28q-4-15-19-12 4 12 19 12ZM50 28q5-15 19-12-3 12-19 12Z" fill="#2d9b45" stroke="#8af09a" strokeWidth="2" />
          <path d="M50 29V18" stroke="#6f4212" strokeWidth="4" strokeLinecap="round" />
          <circle cx="50" cy="58" r="34" fill="#ef7214" stroke="#ffd6a3" strokeWidth="3" />
          <ellipse cx="39" cy="46" rx="8" ry="5" fill="#fff" opacity=".3" transform="rotate(-25 39 46)" />
          <circle cx="62" cy="66" r="2" fill="#bc4608" /><circle cx="31" cy="62" r="2" fill="#bc4608" />
        </svg>
      )}
    </div>
  );
