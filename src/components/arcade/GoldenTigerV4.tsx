  ...
  return (
    <main className="min-h-dvh overflow-x-hidden bg-[#070102] text-white sm:px-3 sm:py-2">
      <section className="relative mx-auto min-h-dvh w-full max-w-[430px] overflow-hidden bg-[linear-gradient(180deg,#491008_0%,#260006_42%,#160004_100%)] shadow-[0_0_90px_rgba(0,0,0,.96)] sm:min-h-0 sm:rounded-[28px] sm:border sm:border-yellow-500/30">
        ...
        {bigWin && showWinFx && <div className="gt4-result-card gt4-result-card--big pointer-events-none absolute left-1/2 top-[52%] z-[65] -translate-x-1/2 rounded-2xl border-2 border-yellow-200 bg-red-950/90 px-5 py-3 text-center font-serif text-3xl font-black text-yellow-100 shadow-[0_0_45px_rgba(255,199,39,.9)]">BIG WIN!</div>}
